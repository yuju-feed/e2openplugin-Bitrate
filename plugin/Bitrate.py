...
#  Update by RAED
#
#	<widget source="session.CurrentService" render="Label" position="1700,60" size="250,32" font="Regular; 24" zPosition="3" halign="left" transparent="1" >
#		<convert type="Bitrate">Video: %V Kbit/s</convert>
#	</widget>
#	<widget source="session.CurrentService" render="Label" position="1700,100" size="250,32" font="Regular; 24" zPosition="3" halign="left" transparent="1" >
#		<convert type="Bitrate">Audio :%A Kbit/s</convert>
#	</widget>
...
class Bitrate(Converter, object):
	VPID = 0
	APID = 1
	FORMAT = 2
